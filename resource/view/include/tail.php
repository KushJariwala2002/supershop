							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										...
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+91 88154 17715</a></li>
										<li><span class="contact-info-label">Email: </span> <a href="tusharkashayp2001@gmail.com">tusharkashayp2001@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//Smartinfosys.net" target="_blank"> Tushar Kashyap </a>
						</p>
